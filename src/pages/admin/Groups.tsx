              ...
              <div className="mb-4">
                <div className="relative max-w-md">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent text-slate-900 placeholder-slate-400"
                  />
                </div>
              </div>
          ...
          <Card>
            <div className="p-12 text-center">
              ...
              <Button
                onClick={() => selectedDepartment && fileInputRef.current?.click()}
                disabled={!selectedDepartment}
                className="bg-primary hover:bg-accent disabled:opacity-50"
              >
                <Upload className="w-4 h-4 mr-2" />
                Upload Students
              </Button>
