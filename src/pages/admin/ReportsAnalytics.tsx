  ...
  return (
    <MainLayout title="Reports & Analytics">
      <div className="space-y-6">
        <Card>
          <h2 className="text-xl font-semibold text-primary mb-4">System Performance</h2>
          {loading ? (
        ...
        <Card>
          <h2 className="text-lg font-semibold text-primary mb-4">Grouping Quality</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 border border-gray-200 rounded-lg">
        ...
        <Card>
          <h2 className="text-lg font-semibold text-primary mb-4">Supervisor Workload</h2>
